...
function GameNM({data}) {
  const {mode, columns, rows, restartTime, calculateTimeRemaining, rowNumber, inputsNumberArray, setinputsNumberArray, rowStatus, setrowStatus, gameWon, setGameWon, gameLost, setGameLost } = data
