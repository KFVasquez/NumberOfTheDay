  ...
  return (
    <div id='App'>
      ...
      <div className='gameDiv'>
        <GameND data={{mode, columns, rows, restartTime, calculateTimeRemaining, rowNumber, numberDayArray, setNumberDayArray, inputsNumberArray, setinputsNumberArray, rowStatus, setrowStatus, gameWon, setGameWon, gameLost, setGameLost, inputFocused}}/>
      </div>
